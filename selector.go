...
var (
	AddrListEmptyErr      = errors.New("addr list is emtpy")
	AddrExistErr          = errors.New("addr exist")
	AddrDoesNotExistErr   = errors.New("addr does not exist")
	NoAvailableAddressErr = errors.New("no available address")
)
